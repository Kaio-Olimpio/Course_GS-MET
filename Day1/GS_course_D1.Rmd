...
BRR = BGLR(y = pheno_L$Y, ETA = ETA, nIter = 30000, burnIn = 1000, 
           thin = 5, verbose = F)
...
BayesB = BGLR(y = pheno_L$Y, ETA = ETA, nIter = 30000, burnIn = 1000, 
           thin = 5, verbose = F)

BayesB_GENO = data.frame("Genotype" = pheno_L$GENO,
                      "Yield" = pheno_L$Y,
                      "GEBV" = BayesB$yHat)
